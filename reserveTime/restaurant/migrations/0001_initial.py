# Generated by Django 3.0.8 on 2020-08-01 13:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='company', to=settings.AUTH_USER_MODEL, verbose_name='customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu', to='restaurant.Company', verbose_name='Company')),
            ],
            options={
                'verbose_name': 'Menu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_table', to='restaurant.Company', verbose_name='Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menus', models.ManyToManyField(related_name='reservation', to='restaurant.Menu', verbose_name='Menus')),
                ('table', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='reservation', to='restaurant.Table', verbose_name='Table')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='reservation', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_type', models.CharField(choices=[('1', 'Food'), ('2', 'Drink'), ('3', 'Interior'), ('4', 'Exterior')], max_length=50, verbose_name='type')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photo_owner', to='restaurant.Company', verbose_name='Owner')),
            ],
            options={
                'verbose_name': 'Photo',
        ...
        migrations.AddField(
            model_name='menu',
            name='menu_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_type', to='restaurant.MenuCategory', verbose_name='Type'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
